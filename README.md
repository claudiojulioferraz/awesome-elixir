...
* [doorman](https://github.com/BlakeWilliams/doorman) -  Tools to make Plug, and Phoenix authentication simple and flexible. Build an opinionated interface and easy to use API on top of flexible modules that can also be used directly.
